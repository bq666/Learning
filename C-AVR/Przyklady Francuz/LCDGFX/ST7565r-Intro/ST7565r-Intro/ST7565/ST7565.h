...
void st7565r_LCD_test(_Bool onoff);                        //W³¹cz wszystkie piksele
void st7565r_LCD_Invert(_Bool onoff);                      //Dokonaj inwersji zawartoœci ekranu
void st7565r_LCD_Reverse_Y(_Bool onoff);                   //Odwróæ obraz wzglêdem osi Y
