...
void st7565r_CpyToPage(uint8_t Page);                      //Skopiuj dane pod wskazany nr strony
...
void st7565r_SetText(uint8_t cx, uint8_t cy, const __memx char *tekst, const uint8_t __flash * const __flash font[]); //Wyœwietl podany tekst u¿ywaj¹c wskazanego fontu
#endif /* ST7565_H_ */